export default {
  ...
  no_vigem_installed_instructions: 'ViGEm driver is missing. Please download and install it from this link:<br> https://github.com/nefarius/ViGEmBus/releases/download/v1.22.0/ViGEmBus_1.22.0_x64_x86_arm64.exe',
